...
class RequisicionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Requisicion']))
		{
			...
			if($model->save())
				...
				{
					$model2->attributes=$_POST['DetalleRequisicion'];
					if($model2->save())
					{
						$this->render('create2',array('model'=>$model2));
					}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Requisicion']))
		{
			$model->attributes=$_POST['Requisicion'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_requisicion));
		}
	...
	{
		$model= new Requisicion;
		$dataProvider=new CActiveDataProvider('Requisicion');
	 ...
	 * @param Requisicion $model the model to be validated
	 */
	...
	public function actionForm2()
{
    ...
    /*
    if(isset($_POST['ajax']) && $_POST['ajax']==='detalle-requisicion-_form2-form')
    {
        echo CActiveForm::validate($model);
        Yii::app()->end();
    }
